...
# Clueweb id map path
id_map_path="/data/group_data/cx_group/REC/ClueWeb-Reco/cwid_to_id.tsv"
...
# Item/Corpus encoding 
python TASTE/encode.py \
    --item_encoding \
    --id_map_path $id_map_path\
    --best_model_path $best_model_path \
    --output_path $output_dir/clueweb22-corpus.cweb.${shard}.pkl \
