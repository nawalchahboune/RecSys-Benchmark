...
def main() -> None:
    ...
    get_common_preprocessors()["amzn-beauty"].preprocess_rating()
    get_common_preprocessors()["amzn-toys"].preprocess_rating()
    get_common_preprocessors()["amzn-sports"].preprocess_rating()
    get_common_preprocessors()["amzn-books"].preprocess_rating()
