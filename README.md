...
- [Public Benchmark](#public-benchmark)
    ...
    - [HLLM](#hllm)
        ...
        - [HLLM Data Preparation](#hllm-data-preparation)
...
We provide scripts to prepare data for HLLM experiments in the `reproduce/transform_datda_format.sh` script.
Note that we assume you have already downloaded the raw data and formatted the data into official splits as described in [Public Dataset Preparation](#public-datasets-preparation).
