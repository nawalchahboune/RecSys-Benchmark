...
bash
# Navigate to quick_start directory
cd quick_start/

# Run inference using the eval_only flag
...
cp recbole/model/sequential_recommender/sasrecf.py \
   $VIRTUAL_ENV/lib/python3.10/site-packages/recbole/model/sequential_recommender/sasrecf.py

cp recbole/config/configurator.py \
   $VIRTUAL_ENV/lib/python3.10/site-packages/recbole/config/configurator.py
